...
📁 Структура проекта:
Employee.kt - базовый класс Employee с методами work(), haveLunch(), goHome()

ClassHomework.kt - мой класс DataScience и точка входа main()

Полный Android проект с конфигурацией Gradle
